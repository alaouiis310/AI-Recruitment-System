...
// Les clés primaires sont numériques : /entreprises/abc renvoie 404 sans interroger la base.
...
Route::middleware(['auth:sanctum', 'compte.actif'])->group(function () {
    ...
    Route::middleware('role:candidat')->prefix('candidat')->group(function () {
        ...
        // Le candidat dépose et remplace son CV à tout moment (RG22/RG23).
        ...
        // Compétences déclarées et leur niveau de maîtrise (RG24/RG26).
        ...
        // Une seule candidature par candidat et par offre (RG27/RG31).
        ...
        // Le candidat consulte les tests reçus sur sa candidature (RG45).
        Route::get('/candidatures/{candidature}/tests', [ResultatTestController::class, 'parCandidature']);

        // Le candidat consulte les entretiens de sa candidature sans pouvoir les modifier (RG34).
    ...
    Route::middleware('role:recruteur')->prefix('recruteur')->group(function () {
        ...
        // Le recruteur ne gère que les offres qu'il a publiées (RG12/RG13).
        ...
        // Le recruteur ne voit que les candidatures portant sur les offres qu'il a publiées (RG14).
        ...
        // Résultat de l'analyse, et relance après mise à jour du profil du candidat (RG37/RG42).
        Route::get('/candidatures/{candidature}/analyse', [AnalyseIaController::class, 'show']);
        Route::post('/candidatures/{candidature}/analyse', [AnalyseIaController::class, 'relancer']);

        // Envoi d'un test au candidat et saisie de son score (RG45).
